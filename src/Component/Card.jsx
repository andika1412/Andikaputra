  ...
  return (
    <div>
      <div className=" px-[20px] w-[341px] mx-auto  mt-[48px]   ">
        <div
          className="border  border-batas rounded-[6px] my-[9px] w-[300px] h-[210px]  lg:grayscale-[80%] hover:grayscale-0  ease-in-out delay-200  duration-300  py-[12px] font-Inter md:text-[18px] text-[16px] hover:relative transition-colors before:absolute before:left-0 before:rounded-[6px] before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-bigtext before:transition-transform before:duration-300  hover:text-white before:hover:scale-x-100
        "
        >
