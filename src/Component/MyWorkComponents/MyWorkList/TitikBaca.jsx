      ...
      <div className="px-[24px] md:px-[100px] max-w-[1100px]  mt-[32px] flex flex-col mx-auto">
        <div className="font-Inter">
          ...
          <div className="pt-[24px]">
            <h1 className="text-[40px] font-bold text-bigtext"> Titik Baca Digital</h1>
          </div>
          ...
          <div className="pt-[24px] pb-[40px]">
            <h1 className="text-[24px] text-paragraf font-semibold">Client : PT Maxima Inditech Media</h1>
            <h1 className="text-[24px] text-paragraf font-semibold pt-[12px]">Year : 2021-2022</h1>
            <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">Project Overview</h1>
            <p className="text-paragraf pt-[20px] text-[20px] leading-[50px] ">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1">
              <div className="flex flex-col ">
                <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">My Role</h1>

                <p className="text-paragraf pt-[16px] text-[20px]  ">UX Research & UI/UX Designer</p>
              </div>

              <div className="flex flex-col ">
                <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">Responbilities</h1>

                <p className="text-paragraf pt-[16px] text-[20px] leading-[40px]  ">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1">
              <div className="flex flex-col ">
                <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">Time Line</h1>

                <p className="text-paragraf pt-[16px] text-[24px]  ">April 2022 - Maret 2023</p>
              </div>

              <div className="flex flex-col ">
                <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">Tools</h1>

                <div className="flex flex-wrap   p-[2px]  gap-6">
                  <div className="flex items-center gap-3 pt-[12px]">
                    <p className="text-paragraf  text-[24px] ">Figma</p>
                  ...
                  <div className="flex  items-center gap-3 pt-[12px]">
                    <p className="text-paragraf  text-[24px] ">Maze</p>
                  ...
                  <div className="flex  items-center gap-3 pt-[12px]">
                    <p className="text-paragraf  text-[24px] min-w-max ">Google Meet</p>
            ...
            <div>
              {" "}
              <h1 className="text-[34px] text-bigtext font-bold pt-[60px]">The Problem</h1>
              <div className="pt-[32px] md:w-full">
                <img src="https://andika1412.github.io/Andikaputra/Images/Readbook.png" alt="" className="rounded-xl w-full object-cover" />
              </div>
              <p className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <div>
              <h1 className="text-[34px] text-bigtext font-bold pt-[40px]">How Titik Baca Digital Work</h1>
              <div className="mt-[32px] bg-slate-400 md:w-full  ">
                <img src="../Images/Titikbacasport.png" alt="" className="rounded-xl w-full  " />
              </div>
              <p className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <h1 className="text-[34px] text-bigtext font-bold pt-[60px]"> Design Decisions</h1>
            {/* //On boarding */}
            <h1 className="text-[34px] text-bigtext font-semibold pt-[24px]">On Boarding</h1>
            <div className="pt-[24px] w-full">
              <img src="https://andika1412.github.io/Andikaputra/Images/Onboarding.png" alt="" className="rounded-xl  w-full object-cover" />
            </div>
            <p className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            {/* //Home Screen */}
            <h1 className="text-[36px] text-bigtext font-semibold pt-[60px]">Home Screen</h1>
            <div className="pt-[24px] w-full">
              <img src="https://andika1412.github.io/Andikaputra/Images/Homescreen.png" alt="" className="rounded-xl  w-full object-cover" />
            </div>
            <div className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <div>
              <h1 className="text-[36px] text-bigtext font-semibold pt-[60px]">TitikBaca Location</h1>
              <div className="pt-[24px] w-full">
                <img src="https://andika1412.github.io/Andikaputra/Images/Location.png" alt="" className="rounded-xl  w-full object-cover" />
              </div>
              <div className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <h1 className="text-[36px] text-bigtext font-semibold pt-[60px]">Detail Places</h1>
            <div className="pt-[24px] w-full">
              <img src="https://andika1412.github.io/Andikaputra/Images/Place.png" alt="" className="rounded-xl  w-full object-cover" />
            </div>
            <p className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <h1 className="text-[36px] text-bigtext font-semibold pt-[60px]">Scan Qr</h1>
            <div className="pt-[24px] w-full">
              <img src="https://andika1412.github.io/Andikaputra/Images/Scanqr.png" alt="" className="rounded-xl  w-full object-cover" />
            </div>
            <div className="text-paragraf pt-[16px] text-[20px] leading-[50px] ">
            ...
            <h1 className="text-[34px] text-bigtext font-bold pt-[60px] mb-[32px]">Final Result</h1>
            <div className="pt-[24px] w-full">
              <img src="https://andika1412.github.io/Andikaputra/Images/Final1.png" alt="" className="rounded-xl  w-full object-cover" />
              <img src="https://andika1412.github.io/Andikaputra/Images/Final2.png" alt="" className="pt-[24px] rounded-xl  w-full object-cover" />
            </div>
          </div>
