      ...
      <div className="   md:mt-[170px] mt-[30px] md:pb-[100px] max-w-[1000px] mx-[24px] md:mx-auto  ">
        <div className="container mx-auto  ">
          <div className="flex flex-wrap-reverse  py-[12px]">
            <div className="w-full   xl:w-1/2 my-auto pb-[24px]">
              ...
              <div className="flex flex-wrap justify-center pt-[32px] content-center pb-[32px] md:justify-normal ">
                <div className="w-full md:w-1/2 max-w-fit  max-h-fit ">
                  <button
                    className="md:py-[24px]  md:px-[56px] md:text-[18px] mb-[24px] py-[22px] px-[120px] bg-bigtext text-white font-Inter font-semibold text-[16px] rounded-[6px] md:mr-[24px]  hover:border hover:border-bigtext hover:-translate-y-1 transition ease-in-out delay-50  duration-300 hover:relative
                ...
                <div className="w-full md:w-1/2 max-w-fit  max-h-fit  ">
                  <button
                    className="md:py-[24px]  md:px-[56px] md:text-[18px]  py-[18px] px-[120px]  border border-bigtext text-bigtext font-Inter font-semibold text-[16px] rounded-[6px] hover:bg-bigtext hover:border-0 hover:-translate-y-1  transition ease-in-out delay-50  duration-300
                  hover:relative
            ...
            <div className=" w-full  xl:w-1/2 px-[12px] md:px-0 ">
